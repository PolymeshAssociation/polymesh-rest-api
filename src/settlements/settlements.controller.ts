...
export class SettlementsController {
  ...
  @ApiOperation({
    ...
    description:
      'This endpoint will provide the affirmation statuses for offchain legs in a Instruction',
  })
  @ApiParam({
    name: 'id',
    description: 'The ID of the Instruction whose offchain affirmations are to be fetched',
    type: 'string',
    example: '123',
  })
  @ApiArrayResponse(OffChainAffirmationModel, {
    description: 'List of all offchain affirmations received',
    paginated: false,
  })
  @Get('instructions/:id/offchain-affirmations')
  ...
  @ApiTags('instructions')
  @ApiOperation({
    summary: 'Get offchain affirmation status for a specific leg',
    description:
  ...
  @Get('instructions/:id/offchain-affirmations/:legId')
